...
control 'xccdf_org.cisecurity.benchmarks_rule_2.2.17_L1_Configure_Deny_access_to_this_computer_from_the_network' do
  ...
  "
  impact 1.0
  a = ((users.where { username.casecmp('Guests') == 0 }.uids.entries + groups.where { name.casecmp('Guests') == 0 }.gids.entries) + (users.where { username =~ /^(NT AUTHORITY\\)?Local account and member of Administrators group$/ }.uids.entries + groups.where { name =~ /^(NT AUTHORITY\\)?Local account and member of Administrators group$/ }.gids.entries)).uniq
  a.each do |entry|
    describe security_policy do
      its('SeDenyNetworkLogonRight') { should include entry }
    end
  end
  a = (((((users.where { username =~ /.*/ }.uids.entries + groups.where { name =~ /.*/ }.gids.entries) - (users.where { username.casecmp('Guests') == 0 }.uids.entries + groups.where { name.casecmp('Guests') == 0 }.gids.entries)) & ((users.where { username =~ /.*/ }.uids.entries + groups.where { name =~ /.*/ }.gids.entries) - ['S-1-5-113']))) & ((users.where { username =~ /.*/ }.uids.entries + groups.where { name =~ /.*/ }.gids.entries) - (users.where { username =~ /^(NT AUTHORITY\\)?Local account$/ }.uids.entries + groups.where { name =~ /^(NT AUTHORITY\\)?Local account$/ }.gids.entries))).uniq
  a.each do |entry|
    describe security_policy do
...
control 'xccdf_org.cisecurity.benchmarks_rule_2.2.21_L1_Ensure_Deny_log_on_through_Remote_Desktop_Services_to_include_Guests_Local_account' do
  ...
  "
  impact 1.0
  a = ((users.where { username.casecmp('Guests') == 0 }.uids.entries + groups.where { name.casecmp('Guests') == 0 }.gids.entries) + (users.where { username =~ /^(NT AUTHORITY\\)?Local account$/ }.uids.entries + groups.where { name =~ /^(NT AUTHORITY\\)?Local account$/ }.gids.entries)).uniq
  a.each do |entry|
    describe security_policy do
...
control 'xccdf_org.cisecurity.benchmarks_rule_2.3.7.6_L2_Ensure_Interactive_logon_Number_of_previous_logons_to_cache_in_case_domain_controller_is_not_available_is_set_to_4_or_fewer_logons_MS_only' do
  ...
  describe registry_key('HKEY_LOCAL_MACHINE\\Software\\Microsoft\\Windows NT\\CurrentVersion\\Winlogon') do
    its('CachedLogonsCount') { should match(//) }
  end
end
...
control 'xccdf_org.cisecurity.benchmarks_rule_2.3.11.4_L1_Ensure_Network_security_Configure_encryption_types_allowed_for_Kerberos_is_set_to_RC4_HMAC_MD5_AES128_HMAC_SHA1_AES256_HMAC_SHA1_Future_encryption_types' do
  ...
  describe registry_key('HKEY_LOCAL_MACHINE\\Software\\Microsoft\\Windows\\CurrentVersion\\Policies\\System\\Kerberos\\Parameters') do
    its('SupportedEncryptionTypes') { should cmp == 2_147_483_644 }
  end
end
...
control 'xccdf_org.cisecurity.benchmarks_rule_9.1.8_L1_Ensure_Windows_Firewall_Domain_Logging_Size_limit_KB_is_set_to_16384_KB_or_greater' do
  ...
  describe registry_key('HKEY_LOCAL_MACHINE\\Software\\Policies\\Microsoft\\WindowsFirewall\\DomainProfile\\Logging') do
    its('LogFileSize') { should cmp >= 16_384 }
  end
end
...
control 'xccdf_org.cisecurity.benchmarks_rule_18.4.5.1_L2_Ensure_Enable_Font_Providers_is_set_to_Disabled' do
...
control 'xccdf_org.cisecurity.benchmarks_rule_18.8.23.1_L2_Ensure_Support_device_authentication_using_certificate_is_set_to_Enabled_Automatic' do
...
control 'xccdf_org.cisecurity.benchmarks_rule_18.8.29.5.1_L2_Ensure_Allow_network_connectivity_during_connected-standby_on_battery_is_set_to_Disabled' do
...
control 'xccdf_org.cisecurity.benchmarks_rule_18.8.29.5.2_L2_Ensure_Allow_network_connectivity_during_connected-standby_plugged_in_is_set_to_Disabled' do
...
control 'xccdf_org.cisecurity.benchmarks_rule_18.8.29.5.3_L2_Ensure_Require_a_password_when_a_computer_wakes_on_battery_is_set_to_Enabled' do
...
control 'xccdf_org.cisecurity.benchmarks_rule_18.8.29.5.4_L2_Ensure_Require_a_password_when_a_computer_wakes_plugged_in_is_set_to_Enabled' do
...
control 'xccdf_org.cisecurity.benchmarks_rule_18.9.37.2_L2_Ensure_Turn_off_location_is_set_to_Enabled' do
...
control 'xccdf_org.cisecurity.benchmarks_rule_18.9.41.1_L2_Ensure_Allow_Extensions_is_set_to_Disabled' do
  ...
  desc  "
    ...
    The recommended state for this setting is: Disabled.
    Rationale: To prevent malicious extensions from being loaded, only approved extensions should be installed.
  "
  impact 1.0
  describe registry_key('HKEY_LOCAL_MACHINE\\SOFTWARE\\Policies\\Microsoft\\MicrosoftEdge\\Extensions') do
    it { should have_property 'ExtensionsEnabled' }
  end
  describe registry_key('HKEY_LOCAL_MACHINE\\SOFTWARE\\Policies\\Microsoft\\MicrosoftEdge\\Extensions') do
    its('ExtensionsEnabled') { should cmp == 0 }
  end
end

control 'xccdf_org.cisecurity.benchmarks_rule_18.9.41.2_L2_Ensure_Allow_InPrivate_Browsing_is_set_to_Disabled' do
...
control 'xccdf_org.cisecurity.benchmarks_rule_18.9.41.5_L2_Ensure_Configure_Pop-up_Blocker_is_set_to_Enabled' do
  ...
  impact 1.0
  describe registry_key('HKEY_LOCAL_MACHINE\\SOFTWARE\\Policies\\Microsoft\\MicrosoftEdge\\Main') do
    it { should have_property 'AllowPopups' }
  end
  describe registry_key('HKEY_LOCAL_MACHINE\\SOFTWARE\\Policies\\Microsoft\\MicrosoftEdge\\Main') do
    its('AllowPopups') { should cmp 'yes' }
  end
end
...
control 'xccdf_org.cisecurity.benchmarks_rule_18.9.41.8_L2_Ensure_Prevent_access_to_the_aboutflags_page_in_Microsoft_Edge_is_set_to_Enabled' do
  ...
  impact 1.0
  describe registry_key('HKEY_LOCAL_MACHINE\\SOFTWARE\\Policies\\Microsoft\\MicrosoftEdge\\Main') do
    it { should have_property 'PreventAccessToAboutFlagsInMicrosoftEdge' }
  end
  describe registry_key('HKEY_LOCAL_MACHINE\\SOFTWARE\\Policies\\Microsoft\\MicrosoftEdge\\Main') do
    its('PreventAccessToAboutFlagsInMicrosoftEdge') { should cmp == 1 }
  end
end

control 'xccdf_org.cisecurity.benchmarks_rule_18.9.41.9_L2_Ensure_Prevent_bypassing_SmartScreen_prompts_for_files_is_set_to_Enabled' do
...
control 'xccdf_org.cisecurity.benchmarks_rule_18.9.41.10_L2_Ensure_Prevent_bypassing_SmartScreen_prompts_for_sites_is_set_to_Enabled' do
...
control 'xccdf_org.cisecurity.benchmarks_rule_18.9.41.11_L2_Ensure_Prevent_using_Localhost_IP_address_for_WebRTC_is_set_to_Enabled' do
...
control 'xccdf_org.cisecurity.benchmarks_rule_18.9.52.3.10.1_L2_Ensure_Set_time_limit_for_active_but_idle_Remote_Desktop_Services_sessions_is_set_to_Enabled_15_minutes_or_less' do
  ...
  describe registry_key('HKEY_LOCAL_MACHINE\\SOFTWARE\\Policies\\Microsoft\\Windows NT\\Terminal Services') do
    its('MaxIdleTime') { should cmp <= 900_000 }
  end
  describe registry_key('HKEY_LOCAL_MACHINE\\SOFTWARE\\Policies\\Microsoft\\Windows NT\\Terminal Services') do
    it { should have_property 'MaxIdleTime' }
  end
...
control 'xccdf_org.cisecurity.benchmarks_rule_18.9.52.3.10.2_L2_Ensure_Set_time_limit_for_disconnected_sessions_is_set_to_Enabled_1_minute' do
  ...
  describe registry_key('HKEY_LOCAL_MACHINE\\SOFTWARE\\Policies\\Microsoft\\Windows NT\\Terminal Services') do
    its('MaxDisconnectionTime') { should cmp == 60_000 }
  end
end
...
control 'xccdf_org.cisecurity.benchmarks_rule_18.9.61.1_L2_Ensure_Disable_all_apps_from_Windows_Store_is_set_to_Enabled' do
...
control 'xccdf_org.cisecurity.benchmarks_rule_18.9.61.4_L2_Ensure_Turn_off_the_Store_application_is_set_to_Enabled' do
...
control 'xccdf_org.cisecurity.benchmarks_rule_18.9.69.8.1_L2_Ensure_Configure_Watson_events_is_set_to_Disabled' do
...
control 'xccdf_org.cisecurity.benchmarks_rule_19.7.7.1_L2_Ensure_Configure_Windows_spotlight_on_Lock_Screen_is_set_to_Disabled' do
  ...
  desc  "
    ...
    The recommended state for this setting is: Disabled.
    **Note:**[Per Microsoft TechNet](https://technet.microsoft.com/en-us/itpro/windows/manage/group-policies-for-enterprise-and-education-editions), this policy setting only applies to Windows 10 Enterprise and Windows 10 Education.
    Rationale: Enabling this setting will help ensure your data is not shared with any third party. The Windows Spotlight feature will collect data and display suggested apps as well as images from the internet.
  "
  impact 1.0
...
control 'xccdf_org.cisecurity.benchmarks_rule_19.7.7.3_L2_Ensure_Turn_off_all_Windows_spotlight_features_is_set_to_Enabled' do
...
control 'xccdf_org.cisecurity.benchmarks_rule_19.7.43.2.1_L2_Ensure_Prevent_Codec_Download_is_set_to_Enabled' do
  ...
  desc  "
    ...
    The recommended state for this setting is: Enabled.
    Rationale: This has some potential for risk if a malicious data file is opened in Media Player that requires an additional codec to be installed. If a special codec is required for a necessary job function, then that codec should be tested and supplied by the IT department in the organization.
  "
  impact 1.0
